...
class ScoreMap_SharedMemory(Map):
    ...
    def __init__(self, terrain_map, process_count):
        ...
        super(ScoreMap_SharedMemory, self).__init__(score_array, width, height)
...
ScoreMap_SharedMemory(TerrainMap('test.map'), 1)
